...
This will open a Bash shell in the container. Once you're in the container, you can test code, especially seeing whether your files can be seen by the container (see @sec-bindpaths).
...
flowchart LR
    ...
    A --write-->C("--bind /fh/fast/mydata/:/mydata/")
    C --read--> A
